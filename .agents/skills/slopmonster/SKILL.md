...
|---|---|---|
| Codex / Codex | Anthropic | GPT-5.6 via the codex CLI — `tools/cleanse.sh` does this |
| Codex / ChatGPT | OpenAI | Codex via `Codex -p`, or set `DESLOP_WRITER=gpt` for `cleanse.sh` |
