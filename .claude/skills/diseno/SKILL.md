...
7. **El modo plan de Claude es opcional, y lo activas tú.** Yo no puedo encenderlo. Lo que sí
...
La skill es una carpeta de texto: se copia entera a `.claude/skills/diseno/` del otro proyecto y
